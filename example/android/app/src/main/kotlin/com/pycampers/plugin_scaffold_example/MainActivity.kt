...
class MyPlugin {
    ...
    */
    fun counterOnListen(id: Int, args: Any?, sink: EventSink) {
        var count = 0
        timers[id] = timer(
    ...
    */
    ...
    fun brokenStream1OnListen(id: Int, args: Any?, sink: EventSink) {
    ...
    fun brokenStream2OnListen(id: Int, args: Any?, sink: EventSink) {
        trySend(sink) {
